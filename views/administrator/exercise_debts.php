...
<?php
// Utiliser la première session de l'exercice - Logic kept just in case but tables removed
$firstSession = !empty($sessions) ? $sessions[0] : null;
?>

    <div class="row mt-4">
        <div class="col-12 white-block">
            <h3 class="text-muted text-center section-title">Dettes d'exercices (Précédents)</h3>
            <hr>
