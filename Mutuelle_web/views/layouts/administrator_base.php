            ...
            <div class="d-flex align-items-center">
                <div class="dropdown">
                    <a class="profile-menu" href="#" id="profileDropdown" role="button" data-toggle="dropdown">
                        <?php 
                        $userForAvatar = isset($this->params['user']) ? $this->params['user'] : null;
                        $adminUsername = isset($this->params['administrator']) ? $this->params['administrator']->username : 'Admin';
                        ?>
                        <img src="<?= \app\managers\FileManager::loadAvatar($userForAvatar) ?>" alt="<?= $adminUsername ?>">
                        <span class="d-none d-md-inline"><?= $adminUsername ?></span>
                    </a>
